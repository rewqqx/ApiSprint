...
Revision ID: b6c7cdca736c
Revises: 68cf0feb24b3
Create Date: 2023-02-26 15:06:26.506534
...
revision = 'b6c7cdca736c'
down_revision = '68cf0feb24b3'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    t = op.execute("INSERT INTO users")
    print(t)

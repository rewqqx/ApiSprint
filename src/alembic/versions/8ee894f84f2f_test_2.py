...
Revision ID: 8ee894f84f2f
Revises: 0c1a0dd59a32
Create Date: 2023-02-26 15:23:24.374418
...
revision = '8ee894f84f2f'
down_revision = '0c1a0dd59a32'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    con = op.get_bind()
    results = con.execute(sa.text("SELECT id FROM users where role='admin'"))
    print(results.id)
